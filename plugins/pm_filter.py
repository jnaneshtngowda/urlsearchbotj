...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('Thanks To Using Me 😇')
            else:
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('Thanks To Using Me 😇')
        ...
        buttons = [[
            InlineKeyboardButton('👩‍🦯 Back', callback_data='help'),
            InlineKeyboardButton('♻️', callback_data='refresh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if imdb and imdb.get('poster'):
        try:
          ...
          await a.delete()
            ...
            logger.exception(e)
            fek = await message.reply_photo(photo="https://telegra.ph/file/4e7e0a76a54d16ce2b80c.jpg", caption=cap, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(300) 
            await fek.delete() 
            await msg.delete()
    else:
